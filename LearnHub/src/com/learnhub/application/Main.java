...
public class Main {
    public static void main(String[] args) {
        ...
        Curso curso = cursoService.criarCurso("1", "Java para Iniciantes", "Curso introdutório de Java", NivelCurso.INICIANTE,  instrutor, "40 horas", new java.util.Date(), StatusCurso.PUBLICADO);
